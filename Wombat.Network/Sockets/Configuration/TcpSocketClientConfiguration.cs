...
namespace Wombat.Network.Sockets
{
    ...
    : this(new SegmentBufferManager(1024, 32768, 1, true))
        ...
        public TcpSocketClientConfiguration(ISegmentBufferManager bufferManager)
        {
            ...
            ReceiveBufferSize = 32768;                   // Specifies the total per-socket buffer space reserved for receives. This is unrelated to the maximum message size or the size of a TCP window.
            SendBufferSize = 32768;                      // Specifies the total per-socket buffer space reserved for sends. This is unrelated to the maximum message size or the size of a TCP window.
